...
driver.find_element(By.ID,"mat-input-1").send_keys("bransen.daniels+selen8@gmail.com")
time.sleep (3)
driver.find_element(By.XPATH,"//span[normalize-space()='NEXT']").click()
time.sleep (3)
driver.find_element(By.ID,"mat-input-3").send_keys("Bransen8")
driver.find_element(By.ID,"mat-input-4").send_keys("Daniels8")
